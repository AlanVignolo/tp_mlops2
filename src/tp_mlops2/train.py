...
def train_model(data_dir: Path, models_dir: Path) -> None:
    """Tunea, entrena, evalua y guarda el modelo Random Forest y sus artefactos."""
    ...
    print(f"MAE: {metrics['mae_mw']:.1f} MW | MAPE: {metrics['mape']:.2%} | RMSE: {metrics['rmse_mw']:.1f} MW")

if __name__ == "__main__":
    train_model(Path("data"), Path("models"))